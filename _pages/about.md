...
<p align="justify">My vision is to build trustworthy machine intelligence and systems capable of ensuring robustness, safety, controllability, and generalization in safety-critical tasks or complex and uncertain environments, with a special focus on research in trustworthy autonomous mobility, unlocking new capabilities in real-world settings.
